...
if conversation_type == 1 {
	draw_sprite_ext(spr_special_interaction, 0, (41 + string_width(speaker_name)) * image_xscale, 520 * image_yscale, image_xscale, image_yscale, 0, c_white, 1);
} else if conversation_type == 2 {
	draw_sprite_ext(spr_key_interaction, 0, (41 + string_width(speaker_name)) * image_xscale, 520 * image_yscale, image_xscale, image_yscale, 0, c_white, 1);
}
